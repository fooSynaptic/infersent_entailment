...
#GLOVE_PATH = './GloVe/cc.zh.300.vec'
GLOVE_PATH = './GloVe/vocab_vectors.txt'

parser = argparse.ArgumentParser(description='wenda training')
# paths
parser.add_argument("--nlipath", type=str, default='./corpus_train/', help="NLI data path ")
parser.add_argument("--outputdir", type=str, default='glove_modeldir/', help="Output directory")
parser.add_argument("--outputmodelname", type=str, default='GloVe.pickle')
...
def evaluate(epoch, eval_type='valid', final_eval=False):
    ...
    s1[:] = hand_keyerror(s1,word_vec)
    s2[:] = hand_keyerror(s2,word_vec)
...
nli_net.encoder.enc_lstm.flatten_parameters()
